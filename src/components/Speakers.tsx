        ...
        <section className="speakers py-15" style={{
            ...
            <div className="container_speakers" style={{
                ...
                <div className="header_speakers flex justify-center items-center gap-5 my-5">
                    ...
                    <h2 className="title_speakers text-[30px] md:text-[45px] xl:text-[55px] 3xl:text-[64px] text-[#390447] text-center md:leading-[35px] font-bold">
                ...
                <div className="card_container_speakers w-full flex flex-col md:flex-row justify-start items-between mt-10 gap-[5%] mb-10">
                    {speakersData.map((speaker, index) => (
                        <div key={index} className='flex flex-col items-center justify-start mb-10 md:mb-0'>
                            ...
                            <h4 className="card_name_speakers font-semibold text-[20px] xl:text-[24px] 3xl:text-[28px] text-center text-[#390447] mt-3">
                                {speaker.name}
                            </h4>
                ...
                <div className="info_container_speakers flex flex-col justify-center items-center relative border border-[#AD0569] rounded-[35px] py-15 px-10 mt-10">
                    <h2 className="info_title_speakers absolute bg-white px-5 -top-10 text-[20px] md:text-[36px] xl:text-[44px] 3xl:text-[50px] text-[#AD0569] text-center md:leading-[45px] font-semibold">
                        <span className="text-[#390447]">Expertos que convierten</span><br />
                        conocimiento en resultados.
                    </h2>
                    <p className="info_content_speakers text-center text-[16px] xl:text-[18px] 3xl:text-[20px]">
                    ...
                    <Link className='flex justify-center block w-full' to="https://wa.me/573188016709?text=Agendar+un+Speaker">
