        ...
        <div className="footer" style={{
           ...
           <div className="content_footer w-[77%] flex justify-between">
                <ul className="list_social_network flex flex-col gap-8 text-[22px] font-semibold">
                    ...
                    <li className="link_social_footer text-white"><a href=""><img className="inline mr-2" src={icon_linkedin} alt="Cuenta de Linkedin de Event Clap"/> Juan Carlos Giraldo Restrepo</a></li>
                </ul>
