    ...
    return (
        ...
        >
            ...
            <div className="container_2_contact_section" style={{
                ...
                <div className="info_container_2_contact_section flex justify-center items-center gap-[20px] w-[100%]">
                ...
                <button
                        ...
                        className="cta_info_contact_section cursor-pointer bg-[#AD0569] transition duration-300 ease-in-out text-white font-bold hover:bg-[#fff] hover:text-[#AD0569]">
