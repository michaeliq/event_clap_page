...
export default function InfoSectionActivacionBTL() {
    return (
        <section
            className="info_section_activacion_btl relative"
        ...
        >
            <img className="decoration_2_info_section_activacion_btl absolute top-[129px] left-0" src={circle_3} alt="Decoración Web Site Event Clap" />
            <div
                className="info_info_section_activacion_btl"
                style={{
                    width: "38.5%",
                    display: "flex",
            ...
            <div
                ...
                className="img_info_section_activacion_btl flex justify-end align-center "
            >
                <img
                    src={circle_2}
            ...
            <img className="decoration_1_info_section_activacion_btl absolute top-0 right-0 " src={circle_1} alt="Decoración Web Site Event Clap" />
        </section>
    )
}