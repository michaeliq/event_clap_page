...
export default function InfoSectionEventosCorporativos() {
    return (
        <section
            className="info_section_eventos_corporativos relative"
        ...
        >
            <img className="decoration_2_info_section_eventos_corporativos absolute top-[129px] left-0" src={circle_3} alt="Decoración Web Site Event Clap" />
            <div
                className="info_info_section_eventos_corporativos"
                style={{
                    width: "38.5%",
                    display: "flex",
            ...
            >
                <h2 className="title_info_info_section_eventos_corporativos font-bold leading-[45px] text-[40px] text-[#390447] mb-3">
                    Donde las marcas conectan, <br />
                    <span className="font-normal">inspiran y movilizan.</span>
                </h2>
                <p className="description_info_info_section_eventos_corporativos text-[22px] font-Barrow" style={{ width: "80%" }}>
            ...
            <div
                ...
                className="img_info_section_eventos_corporativos flex justify-end align-center "
            >
                <img
                    src={circle_2}
            ...
            <img className="decoration_1_info_section_eventos_corporativos absolute top-0 right-0 " src={circle_1} alt="Decoración Web Site Event Clap" />
        </section>
    )
}