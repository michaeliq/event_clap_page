        ...
        <div className="step_section_bodas" style={{
            ...
            <div className="hidden container_card_services_section_home md:flex justify-center items-center gap-5 w-[77%]">
                {cardsStep?.map((item, key) => (
                    <div key={key} className="card_step_section_bodas relative flex flex-col justify-between w-[18%] h-[350px] bg-white items-center gap-x-6 gap-y-6 px-5 pt-10 pb-10 text-[#390447] rounded-lg" >
            ...
            <Link to="https://wa.me/573188016709?Eventos+de+Bodas" target="_blank" className="flex justify-center">
            <button
                style={{
                    display: "flex",
                    justifyContent: "center",
                ...
                className="w-[100%] md:w-auto cta_info_contact_section cursor-pointer bg-[#fff] transition duration-300 ease-in-out text-center text-[17px] md:text-[25px] xl:text-[30px] 3xl:text-[34px] text-[#390447] font-bold hover:bg-[#fff] hover:text-[#AD0569]">
