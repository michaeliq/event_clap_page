import rectangle_gray from "../../assets/img_27_gallery_section.webp";
import img_2_gallery from "../../assets/img_28_gallery_section.webp";
import img_3_gallery from "../../assets/img_29_gallery_section.webp";
import img_4_gallery from "../../assets/img_30_gallery_section.webp";
import img_5_gallery from "../../assets/img_31_gallery_section.webp";
import img_6_gallery from "../../assets/img_32_gallery_section.webp";
import img_7_gallery from "../../assets/img_33_gallery_section.webp";
        ...
        <section className="gallery_section" id="gallery_section" style={{
            ...
            <div
                ...
                <div className="header_container_gallery_section flex justify-center items-center gap-5 my-5">
                    ...
                    <h2 className="title_gallery_section text-[45px] xl:text-[55px] 3xl:text-[64px] text-[#390447] text-center leading-[35px] font-bold">
                        <span className="uppercase">Galería</span><br />
                        <span className="text-[26px] xl:text-[30px] 3xl:text-[34px] font-Barrow font-normal">Producción Técnica 4.0</span>
                    </h2>
                    <div className="line w-[82px] h-[4px] rounded-[4px] bg-[#720742] relative bottom-[15px]"></div>
                </div>
                {/** Mobile section */}
                ...
                {/** End Mobile Section */}
                <div className="hidden img_content_gallery_section_marketing md:flex flex-col gap-y-4">
