...
export default function StepSectionMarketingEmocional() {
    ...
    return (
        <div className="step_section_marketing_emocional" style={{
            backgroundColor: "#fff",
            ...
            <div className="hidden container_card_services_section_home md:flex justify-center items-center gap-5 w-[77%]">
                {cardsStep?.map((item, key) => (
                    <div key={key} className="card_step_section_marketing_emocional relative flex flex-col justify-between w-[18%] h-[300px] bg-white items-center gap-x-6 gap-y-6 px-5 pt-10 pb-10 text-[#390447] rounded-lg" >
            ...
            <Link to="https://wa.me/573188016709?text=Eventos+de+Marketing+Emocional" target="_blank" className="flex justify-center">
            <button
                style={{
                    display: "flex",
                    justifyContent: "center",
