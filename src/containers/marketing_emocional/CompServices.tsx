...
const cardsStep = [
    {
        ...
        content: "Construimos marcas con propósito, mensaje claro y dirección comercial.",
    },
    {
        title: "Marketing Digital",
        content: "Contenido, publicidad y automatización para crecer y convertir online.",
    },
    {
        title: "Marketing Experiencial",
        content: "Activaciones, eventos y lanzamientos que generan conexión real.",
    },
    {
        title: "Marketing Comercial",
        content: "Ventas consultivas, pitches persuasivos y fidelización estratégica.",
    },
    {
        title: "Marketing Analítico",
        content: "Datos, métricas y optimización constante para decisiones inteligentes.",
    },
]

export default function CompServicesMarketingEmocional(){
    ...
    return(
        <div className="comp_services_marketing_emocional" style={{
                backgroundColor: "#fff",
            ...
            {/** End mobile version */}
                <div className="hidden container_card_services_section_home md:flex justify-center items-center gap-5 w-[77%]">
                    {cardsStep?.map((item,key)=>(
                        <div key={key} className="card_comp_services_marketing_emocional relative flex flex-col justify-between w-[18%] h-[350px] bg-white items-center gap-x-6 gap-y-6 px-5 pt-10 pb-10 text-[#390447] rounded-lg" >
                ...
                <Link to="https://wa.me/573188016709?text=Crear+estrategia+de+Marketing" target="_blank" className="flex justify-center">
                <button
                        style={{
                            display: "flex",
                            justifyContent: "center",
