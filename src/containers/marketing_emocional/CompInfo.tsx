        ...
        <section className="info_comp_marketing_emocional" style={{
            ...
            <div style={{
                ...
                <div className=" flex justify-center items-center gap-5 my-5">
                    ...
                    <h2 className="text-[30px] md:text-[45px] xl:text-[55px] 3xl:text-[64px] text-[#390447] text-center leading-[35px] font-semibold">
                ...
                <div className="flex justify-center items-center gap-5 my-2">
                    <p className="mb-4 text-[22px] xl:text-[26px] 3xl:text-[30px] font-Barrow text-center md:w-[80%]" >
